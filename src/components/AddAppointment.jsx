...
const AddAppointment = ({ maxId, onAddAppointment }) => {
  ...
  const onSubmitForm = () => {
    ...
    onAddAppointment(formattedData)
  }
  ...
  return (
    <div>
      <button 
        ...
        <div><BiCalendarPlus className="inline-block align-baseline"/> Add Appointment</div>
      </button>
      {
        toggleForm &&
        <div className="border-r-2 border-b-2 border-l-2 border-light-blue-500 rounded-b-md pl-4 pr-4 pb-4">
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input 
                type="text" name="ownerName" id="ownerName" value={formData.ownerName}
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input 
                type="text" name="petName" id="petName" value={formData.petName}
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <textarea id="aptNotes" name="aptNotes" rows="3" value={formData.aptNotes}
                ...
                className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md p-2" placeholder="Detailed comments about the condition"></textarea>
            </div>
          </div>
